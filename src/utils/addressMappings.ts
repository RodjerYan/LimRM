...
export const REGION_KEYWORD_MAP: Record<string, string> = {
  ...
  'калужская обл': 'Калужская область', 'калужская область': 'Калужская область', 'обл калужская': 'Калужская область', 'г киров': 'Калужская область',
  ...
  'орловская обл': 'Орловская область', 'орловская область': 'Орловская область', 'обл орловская': 'Орловская область', 'г орёл': 'Орловская область', 'г орел': 'Орловская область',
