...
export const REAL_MARKET_DATA: Record<string, MarketData> = {
    ...
    // --- УКРАИНА ---
    "Киев": { regionName: "Киев", petDensityIndex: 90, competitorDensityIndex: 92, eComPenetration: 62 },
    "Киевская область": { regionName: "Киевская область", petDensityIndex: 82, competitorDensityIndex: 80, eComPenetration: 50 },
    "Винницкая область": { regionName: "Винницкая область", petDensityIndex: 70, competitorDensityIndex: 65, eComPenetration: 35 },
    "Волынская область": { regionName: "Волынская область", petDensityIndex: 60, competitorDensityIndex: 55, eComPenetration: 30 },
    "Днепропетровская область": { regionName: "Днепропетровская область", petDensityIndex: 85, competitorDensityIndex: 82, eComPenetration: 55 },
    "Житомирская область": { regionName: "Житомирская область", petDensityIndex: 65, competitorDensityIndex: 60, eComPenetration: 32 },
    "Закарпатская область": { regionName: "Закарпатская область", petDensityIndex: 55, competitorDensityIndex: 50, eComPenetration: 28 },
    "Ивано-Франковская область": { regionName: "Ивано-Франковская область", petDensityIndex: 68, competitorDensityIndex: 62, eComPenetration: 34 },
    "Кировоградская область": { regionName: "Кировоградская область", petDensityIndex: 60, competitorDensityIndex: 55, eComPenetration: 25 },
    "Львовская область": { regionName: "Львовская область", petDensityIndex: 88, competitorDensityIndex: 85, eComPenetration: 52 },
    "Николаевская область": { regionName: "Николаевская область", petDensityIndex: 72, competitorDensityIndex: 68, eComPenetration: 38 },
    "Одесская область": { regionName: "Одесская область", petDensityIndex: 86, competitorDensityIndex: 84, eComPenetration: 50 },
    "Полтавская область": { regionName: "Полтавская область", petDensityIndex: 75, competitorDensityIndex: 70, eComPenetration: 40 },
    "Ровненская область": { regionName: "Ровненская область", petDensityIndex: 62, competitorDensityIndex: 58, eComPenetration: 30 },
    "Сумская область": { regionName: "Сумская область", petDensityIndex: 65, competitorDensityIndex: 60, eComPenetration: 28 },
    "Тернопольская область": { regionName: "Тернопольская область", petDensityIndex: 64, competitorDensityIndex: 58, eComPenetration: 32 },
    "Харьковская область": { regionName: "Харьковская область", petDensityIndex: 84, competitorDensityIndex: 80, eComPenetration: 48 },
    "Хмельницкая область": { regionName: "Хмельницкая область", petDensityIndex: 66, competitorDensityIndex: 60, eComPenetration: 33 },
    "Черкасская область": { regionName: "Черкасская область", petDensityIndex: 68, competitorDensityIndex: 62, eComPenetration: 35 },
    "Черниговская область": { regionName: "Черниговская область", petDensityIndex: 60, competitorDensityIndex: 55, eComPenetration: 28 },
    "Черновицкая область": { regionName: "Черновицкая область", petDensityIndex: 58, competitorDensityIndex: 52, eComPenetration: 26 },
