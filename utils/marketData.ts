...
export const REAL_MARKET_DATA: Record<string, MarketData> = {
    ...
    "Москва": { regionName: "Москва", petDensityIndex: 97, competitorDensityIndex: 99, eComPenetration: 68, avgOwnerAge: 39 }, // UPDATED
    ...
    "Рязанская область": { regionName: "Рязанская область", petDensityIndex: 68, competitorDensityIndex: 62, eComPenetration: 29, avgOwnerAge: 46 }, // Один из самых старых регионов
    ...
    "Тамбовская область": { regionName: "Тамбовская область", petDensityIndex: 62, competitorDensityIndex: 54, eComPenetration: 23, avgOwnerAge: 47 }, // Высокий средний возраст
    ...
    "Тульская область": { regionName: "Тульская область", petDensityIndex: 77, competitorDensityIndex: 72, eComPenetration: 33, avgOwnerAge: 47 }, // Старейший регион по статистике
    ...
    // --- СЕВЕРО-ЗАПАДНЫЙ ФО ---
    "Санкт-Петербург": { regionName: "Санкт-Петербург", petDensityIndex: 95, competitorDensityIndex: 97, eComPenetration: 63, avgOwnerAge: 40 }, // UPDATED
    ...
    "Мурманская область": { regionName: "Мурманская область", petDensityIndex: 70, competitorDensityIndex: 60, eComPenetration: 35, avgOwnerAge: 39 }, // Относительно молодой (север)
    ...
    "Чеченская Республика": { regionName: "Чеченская Республика", petDensityIndex: 50, competitorDensityIndex: 40, eComPenetration: 18, avgOwnerAge: 29 }, // Самый молодой регион
    ...
    "Ханты-Мансийский автономный округ — Югра": { regionName: "Ханты-Мансийский автономный округ — Югра", petDensityIndex: 76, competitorDensityIndex: 70, eComPenetration: 46, avgOwnerAge: 35 }, // Молодой рабочий регион
    "Ямало-Ненецкий автономный округ": { regionName: "Ямало-Ненецкий автономный округ", petDensityIndex: 71, competitorDensityIndex: 60, eComPenetration: 49, avgOwnerAge: 34 }, // Молодой рабочий регион
    ...
    "Республика Тыва": { regionName: "Республика Тыва", petDensityIndex: 40, competitorDensityIndex: 30, eComPenetration: 15, avgOwnerAge: 30 }, // Очень молодой регион
    ...
    "Республика Саха (Якутия)": { regionName: "Республика Саха (Якутия)", petDensityIndex: 68, competitorDensityIndex: 60, eComPenetration: 40, avgOwnerAge: 34 }, // Молодой регион

    // --- СНГ (Демографический бум в Азии) ---
    "Республика Беларусь": { regionName: "Республика Беларусь", petDensityIndex: 78, competitorDensityIndex: 70, eComPenetration: 28, avgOwnerAge: 42 }, // Ближе к Европе
    "Республика Казахстан": { regionName: "Республика Казахстан", petDensityIndex: 72, competitorDensityIndex: 65, eComPenetration: 24, avgOwnerAge: 32 }, // Молодое население
    "Республика Узбекистан": { regionName: "Республика Узбекистан", petDensityIndex: 55, competitorDensityIndex: 48, eComPenetration: 15, avgOwnerAge: 29 }, // Очень молодое
    "Кыргызская Республика": { regionName: "Кыргызская Республика", petDensityIndex: 50, competitorDensityIndex: 42, eComPenetration: 12, avgOwnerAge: 28 }, // Очень молодое
    "Республика Таджикистан": { regionName: "Республика Таджикистан", petDensityIndex: 45, competitorDensityIndex: 38, eComPenetration: 10, avgOwnerAge: 26 }, // Самое молодое
