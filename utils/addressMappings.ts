...
export const postalToRegion: Record<string, string> = {
    ...
    // Expanded coverage for Bryansk Oblast
    '241': 'Брянская область', '242': 'Брянская область', '243': 'Брянская область',
    // Expanded coverage for Smolensk Oblast
...
export const cityToRegion: Record<string, string> = {
  ...
  "пенза": "Пензенская область", // FIX: Corrected typo from "Пенская"
  "псков": "Псковская область", "ростов-на-дону": "Ростовская область",
