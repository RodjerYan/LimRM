...
export const CITY_NORMALIZATION_MAP: Record<string, string> = {
  ...
  // FIX: Key with comma would never match after normalization. Changed to use a space.
  'г гурьевск': 'гурьевск',
...
export const REGION_KEYWORD_MAP: Record<string, string> = {
  ...
  'брянская обл': 'Брянская область', 'брянская': 'Брянская область', 'обл брянская': 'Брянская область',
  ...
  'калужская обл': 'Калужская область', 'калужская': 'Калужская область', 'обл калужская': 'Калужская область',
  ...
  'орловская обл': 'Орловская область', 'орловская': 'Орловская область', 'обл орловская': 'Орловская область',
  ...
  'смоленская обл': 'Смоленская область', 'смоленская': 'Смоленская область', 'обл смоленская': 'Смоленская область',
