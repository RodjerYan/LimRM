...
export const REGION_KEYWORD_MAP: Record<string, string> = {
  ...
  // Adjectives for strict matching in Subject column (without "oblast")
  ...
  'томская обл': 'Tomskaya oblast', 'томская область': 'Томская область', 'обл томская': 'Томская область',
