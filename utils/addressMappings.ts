...
export const REGION_KEYWORD_MAP: Record<string, string> = {
  ...
  'цхинвали': 'Республика Южная Осетия',
  
  'нагорный карабах': 'Нагорный Карабах',
  'арцах': 'Нагорный Карабах',
  'nagorno-karabakh': 'Нагорный Карабах',
  'степанакерт': 'Нагорный Карабах',
  'ханкенди': 'Нагорный Карабах', // Search works for both names
