...
// с помощью Vercel Cron Job, настроенного на '0 6 * * *' для 9:00 МСК)
// запрашивать данные из надежного источника и кэшировать их.
//
// Этот файл является имитацией такого сервиса и возвращает статичный набор данных,
