// This file is a self-contained copy of the region data for the serverless API function.
// This prevents build issues on Vercel where API routes struggle to import from parent directories.
