...
const getBaseSize = (small?: boolean) => small ? "w-4 h-4" : "w-5 h-5";

export const LoaderIcon: React.FC<IconProps> = ({ className, small }) => (
    <div className={`border-2 border-current border-t-transparent rounded-full animate-spin flex-shrink-0 ${className || getBaseSize(small)}`}></div>
);

export const SuccessIcon: React.FC<IconProps> = ({ className, small }) => (
    <svg className={`flex-shrink-0 ${className || getBaseSize(small)}`} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
export const SortIcon: React.FC<IconProps> = ({ className, small }) => (
    <svg className={`flex-shrink-0 ${className || (small ? "w-3 h-3" : "w-4 h-4")}`} fill="currentColor" viewBox="0 0 20 20">
...
export const SortUpIcon: React.FC<IconProps> = ({ className, small }) => (
    <svg className={`flex-shrink-0 text-accent ${className || (small ? "w-3 h-3" : "w-4 h-4")}`} fill="currentColor" viewBox="0 0 20 20">
...
export const PotentialIcon: React.FC<IconProps> = ({ className, small }) => (
    <svg className={`flex-shrink-0 ${className || getBaseSize(small)}`} fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
