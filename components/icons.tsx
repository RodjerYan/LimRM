...
export const LoaderIcon: React.FC<IconProps> = ({ className = "w-5 h-5" }) => (
    <div className={`border-2 border-gray-400 border-t-white rounded-full animate-spin ${className}`}></div>
);
...
export const MaximizeIcon: React.FC<IconProps> = ({ className = "w-5 h-5" }) => (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
export const FactIcon: React.FC<IconProps> = ({ className = "w-5 h-5" }) => (
...
export const SortUpIcon: React.FC<IconProps> = ({ className = "w-4 h-4" }) => (
    <svg className={`${className} text-accent`} fill="currentColor" viewBox="0 0 20 20">
...
// Added icons to fix missing exports
/**
 * Icon representing potential or high-growth goals.
 */
export const PotentialIcon: React.FC<IconProps> = ({ className = "w-5 h-5" }) => (
    <svg className={className} fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
/**
 * Icon for growth metrics.
 */
export const GrowthIcon: React.FC<IconProps> = ({ className = "w-5 h-5" }) => (
    <svg className={className} fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
/**
 * Icon representing users or clients.
 */
...
/**
 * Calculator icon for quantitative metrics.
 */
...
/**
 * Coverage icon for market presence.
 */
export const CoverageIcon: React.FC<IconProps> = ({ className = "w-5 h-5" }) => (
    <svg className={className} fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
/**
 * Icon for data or databases.
 */
export const DataIcon: React.FC<IconProps> = ({ className = "w-5 h-5" }) => (
    <svg className={className} fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
/**
 * Icon for intelligence or strategy.
 */
...
/**
 * Lab beaker icon for experiments.
 */
export const LabIcon: React.FC<IconProps> = ({ className = "w-5 h-5" }) => (
    <svg className={className} fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
/**
 * Prophet eye icon for forecasting.
 */
export const ProphetIcon: React.FC<IconProps> = ({ className = "w-5 h-5" }) => (
    <svg className={className} fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
/**
 * Waterfall/stepped chart icon.
 */
export const WaterfallIcon: React.FC<IconProps> = ({ className = "w-5 h-5" }) => (
    <svg className={className} fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
/**
 * General analytics icon.
 */
export const AnalyticsIcon: React.FC<IconProps> = ({ className = "w-5 h-5" }) => (
    <svg className={className} fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
