                           ...
                           <li>
                                ...
                                <div className="text-xs text-gray-400 mt-1 space-y-1">
                                    ...
                                    <p className="text-yellow-500">
                                        **Важно:** Скопируйте все содержимое JSON-файла и вставьте его как одну строку. Убедитесь, что нет переносов строк (или используйте `\n` вместо переносов, если копируете вручную).
                                    </p>
