    ...
    return (
        <div className="space-y-6 animate-fade-in">
            <div className="flex justify-between items-end border-b border-gray-800 pb-4">
                <div>
                    <h2 className="text-2xl font-bold text-white">ROI GENOME <span className="text-gray-500 font-normal text-lg">/ Стратегия</span></h2>
                    <p className="text-gray-400 text-sm mt-1">Интеллектуальный слой. Определение стратегических приоритетов (Принцип Парето 20/80).</p>
                </div>
            </div>

            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                {/* Executive Summary Card */}
                <div className="lg:col-span-3 bg-gradient-to-r from-indigo-900/40 to-purple-900/40 border border-indigo-500/30 p-6 rounded-2xl flex flex-col md:flex-row items-center justify-between gap-6">
                    <div className="flex items-start gap-4">
                        <div className="p-3 bg-indigo-500 rounded-xl text-white shadow-lg shadow-indigo-500/30">
                            <BrainIcon />
                        </div>
                        <div>
                            <h3 className="text-xl font-bold text-white">Стратегический Инсайт</h3>
                    ...
                    <div className="text-right">
                        <div className="text-sm text-gray-400 uppercase tracking-wider font-bold">Общий Потенциал Роста</div>
                        <div className="text-3xl font-mono font-bold text-white text-shadow-glow">
                ...
                <div className="lg:col-span-2 bg-gray-900/50 backdrop-blur-xl border border-emerald-500/30 rounded-2xl p-6">
                        ...
                        {paretoData.top20.map((item: ParetoItem, idx: number) => (
                            <div key={item.name} className="flex items-center p-3 bg-gray-800/50 rounded-xl border border-gray-700">
                                ...
                                <div className="text-right min-w-[100px]">
                                    ...
                                    <div className="text-[10px] text-gray-500">потенциал</div>
                                </div>
                            </div>
                        ))}
                    </div>
                ...
                {/* Maintenance (The 80%) */}
                <div className="lg:col-span-1 bg-gray-900/50 backdrop-blur-xl border border-gray-700 rounded-2xl p-6">
                    <h3 className="text-lg font-bold text-white mb-4 flex items-center gap-2">
