...
// Safe getter for original row data to prevent null pointer exceptions
const getSafeOriginalRow = (data: EditableData): any => {
    ...
    const fetchHistory = async (rmName: string, address: string) => {
        ...
        try {
            ...
            if (res.ok) {
                ...
                if (result.history) {
                    // Update: Split by ' || ' to keep grouped events together
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            if (isAddressChanged || isCommentChanged) {
                ...
                if (entryText) {
                    // Update logic: Put new entry at top
                    ...
                    <div className="bg-gray-900/60 p-6 rounded-2xl border border-gray-700 shadow-xl relative flex flex-col gap-5">
                        ...
                        <div className="space-y-4">
                            <div className="relative">
                                ...
                                {saveSuccess && <CheckIcon className="absolute right-4 top-10 text-emerald-400 animate-bounce w-6 h-6" />}
                            </div>
